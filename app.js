...
app.get('/httprtt', routes.httprttform);
app.post('/httprtt', routes.httprtt);

app.get('/port', routes.portform);
app.post('/port', routes.port);
...
io.sockets.on('connection',function (socket) {
  ...
  socket.on('init',function (init) {
    ...
    host.on('httprtt', function (rtt) {
        socket.emit('httprtt', rtt);
      });
